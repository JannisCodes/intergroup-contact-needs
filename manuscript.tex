...
\begin{enumerate}
    ...
    \item are we presenting a relativistic model? i.e. are we breaking theoretical ground? at the end we are saying: it always depends what the main goal of the individual is. Is this hyper applied but not really theoretical? (just a though :) ) Make sure to discuss: (1) practical relevance and (2) core situational need as initial test of the role of motivations.
\end{enumerate}
