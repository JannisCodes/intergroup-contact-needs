...
\begin{enumerate}[label=H\arabic*:]
    ...
    \item Based on Allport’s optimal contact conditions, intergroup interactions with equal status, common goals, collaboration, and structural support should predict more favorable outgroup attitudes due to more positive interaction quality perceptions within the extensive longitudinal data. Based on our proposal, we expect situational need fulfillments to work at least as good as Allport's conditions in predicting outgroup attitudes.
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Core need fulfillment during outgroup interactions should predict higher perceived interaction quality. This sub-hypothesis mirrors the one above so that perceived interaction quality is predicted by core need fulfillment in a multi-level regression analysis.
