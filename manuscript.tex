...
In this article, we propose that the fulfillment of fundamental psychological needs might offer a psycho-social mechanism for understanding and explaining contact quality and in extension positive outgroup attitudes. Additionally, such needs might even explain the effectiveness of Allport's optimal contact conditions, if these conditions constitute common psychological needs of the interacting individuals. To test this we collected three sets of real-life data from recent immigrants, tracking situational needs, interaction quality, and outgroup attitudes, following their daily interactions with host majority group members. 

\section{Psychological Needs in Intergroup Relations}

\faQuestionCircle\ Past research on the mechanisms of Allport's Conditions + research on interaction quality.
