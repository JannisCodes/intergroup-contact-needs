...
%DIF DEL main.tex       Fri May 26 20:56:35 2023
%DIF ADD main_rev.tex   Wed May 31 19:26:30 2023
...
Using three independent sets of extensive longitudinal data (Studies 1–3), the aim of this paper is essentially threefold. \DIFdelbegin \DIFdel{First, our }\DIFdelend \DIFaddbegin \DIFadd{We (1) seek to test the basic ideas of the contact theory within real-world experience sampling data. We (2) aim to test the core need fulfillment mechanism within the real-world data. And we (3) seek to ensure the stability, robustness, and embeddedness of our results.
}

\DIFadd{Firstly, for the general contact hypothesis test, our }\DIFaddend study is among the first to test the fundamental tenets of intergroup contact and Allport's conditions in real-life extensive longitudinal data. Translating the contact hypothesis into extensive longitudinal data is not a trivial task, as past research traditions have used two fundamentally different approaches. While lab studies have tended to focus on the effect of a single positive interaction, cross-section studies have primarily investigated the frequency of positive interactions more generally. Extensive longitudinal data allows us to investigate both. We can test whether having \DIFdelbegin \DIFdel{an }\DIFdelend \DIFaddbegin \DIFadd{a specific type of }\DIFaddend interaction vs. not having an interaction \DIFdelbegin \DIFdel{impacts outgroup attitudes}\DIFdelend \DIFaddbegin \DIFadd{improves intergroup relations}\DIFaddend , but we can also use the participant's 30-day contact reports to test whether participants with more positive interactions tend to \DIFdelbegin \DIFdel{have more positive outgroup attitudes}\DIFdelend \DIFaddbegin \DIFadd{benefit more from intergroup contact}\DIFaddend . Testing both approaches to the contact hypothesis allows us to go beyond a replication of the basic theory but could disentangle individual- from aggregated contact effects and would allow for a direct comparison with both bodies of literature. 
...
attitudes independently). Additionally, while \DIFdelbegin \DIFdel{multi-level }\DIFdelend \DIFaddbegin \DIFadd{multilevel }\DIFaddend regressions
...
contact quality (random intercept model; \textit{b} = \DIFdelbegin \DIFdel{0.42}\DIFdelend \DIFaddbegin \DIFadd{0.37}\DIFaddend ,
\textit{t}(365) = \DIFdelbegin \DIFdel{8.07}\DIFdelend \DIFaddbegin \DIFadd{7.73}\DIFaddend , \textit{p} \textless{} .001,
\textit{95\%CI}{[}\DIFdelbegin \DIFdel{0.32, 0.52}\DIFdelend \DIFaddbegin \DIFadd{0.28, 0.47}\DIFaddend {]}). Moreover, when we consider the
...
model; \textit{b} = \DIFdelbegin \DIFdel{0.23}\DIFdelend \DIFaddbegin \DIFadd{0.24}\DIFaddend , \textit{t}(364) = \DIFdelbegin \DIFdel{4.22}\DIFdelend \DIFaddbegin \DIFadd{4.33}\DIFaddend , \textit{p} \textless{}
.001, \textit{95\%CI}{[}\DIFdelbegin \DIFdel{0.12, 0.33}\DIFdelend \DIFaddbegin \DIFadd{0.13, 0.35}\DIFaddend {]}) and only little unique variance
is still explained by core need fulfillment (\textit{b} = \DIFdelbegin \DIFdel{0.04}\DIFdelend \DIFaddbegin \DIFadd{0.05}\DIFaddend ,
\textit{t}(364) = \DIFdelbegin \DIFdel{0.64}\DIFdelend \DIFaddbegin \DIFadd{0.94}\DIFaddend , \textit{p} = \DIFdelbegin \DIFdel{0.523}\DIFdelend \DIFaddbegin \DIFadd{0.348}\DIFaddend , \textit{95\%CI}{[}\DIFdelbegin \DIFdel{-0.08,
0.15}\DIFdelend \DIFaddbegin \DIFadd{-0.05,
0.14}\DIFaddend {]}, also see \fgrref[-A]{fig:MainPaths}). We thus find support for
...
interaction quality (random slopes model; \textit{b} = \DIFdelbegin \DIFdel{0.40}\DIFdelend \DIFaddbegin \DIFadd{0.29}\DIFaddend ,
\textit{t}(826) = \DIFdelbegin \DIFdel{6.46}\DIFdelend \DIFaddbegin \DIFadd{5.43}\DIFaddend , \textit{p} \textless{} .001,
\textit{95\%CI}{[}\DIFdelbegin \DIFdel{0.28, 0.52}\DIFdelend \DIFaddbegin \DIFadd{0.19, 0.40}\DIFaddend {]}). Additionally, if we consider the
...
\DIFaddbegin \DIFadd{remains a strong predictor }\DIFaddend (random slopes model; \textit{b} = \DIFdelbegin \DIFdel{0.17}\DIFdelend \DIFaddbegin \DIFadd{0.16}\DIFaddend ,
\textit{t}(825) = \DIFdelbegin \DIFdel{5.56}\DIFdelend \DIFaddbegin \DIFadd{5.93}\DIFaddend , \textit{p} \textless{} .001,
\textit{95\%CI}{[}0.11, \DIFdelbegin \DIFdel{0.23}\DIFdelend \DIFaddbegin \DIFadd{0.21}\DIFaddend {]}) and only little unique variance is
still explained by core need fulfillment (\textit{b} = \DIFdelbegin \DIFdel{0.03}\DIFdelend \DIFaddbegin \DIFadd{0.06}\DIFaddend ,
\textit{t}(825) = \DIFdelbegin \DIFdel{1.47}\DIFdelend \DIFaddbegin \DIFadd{2.47}\DIFaddend , \textit{p} = \DIFdelbegin \DIFdel{0.141}\DIFdelend \DIFaddbegin \DIFadd{0.014}\DIFaddend , \textit{95\%CI}{[}\DIFdelbegin \DIFdel{-0.01,
0.07}\DIFdelend \DIFaddbegin \DIFadd{0.01,
0.11}\DIFaddend {]}; also see \fgrref[-B]{fig:MainPaths} and
...
\DIFdelbegin \DIFdel{0.43}\DIFdelend \DIFaddbegin \DIFadd{0.45}\DIFaddend , \textit{t}(1,605) = \DIFdelbegin \DIFdel{8.35}\DIFdelend \DIFaddbegin \DIFadd{9.32}\DIFaddend , \textit{p} \textless{} .001,
\textit{95\%CI}{[}\DIFdelbegin \DIFdel{0.33}\DIFdelend \DIFaddbegin \DIFadd{0.36}\DIFaddend , 0.54{]}). Additionally, once we consider the
influences of core need fulfillment and interaction quality on outgroup
...
\DIFdelbegin \DIFdel{0.17}\DIFdelend \DIFaddbegin \DIFadd{0.16}\DIFaddend , \textit{t}(1,600) = \DIFdelbegin \DIFdel{6.86}\DIFdelend \DIFaddbegin \DIFadd{7.03}\DIFaddend , \textit{p} \textless{} .001,
\textit{95\%CI}{[}\DIFdelbegin \DIFdel{0.12, 0.22}\DIFdelend \DIFaddbegin \DIFadd{0.11, 0.20}\DIFaddend {]}) and the unique variance explained by
core need fulfillment was roughly half of its original effect size
(\textit{b} = \DIFdelbegin \DIFdel{0.11}\DIFdelend \DIFaddbegin \DIFadd{0.12}\DIFaddend , \textit{t}(1,600) = \DIFdelbegin \DIFdel{3.50}\DIFdelend \DIFaddbegin \DIFadd{3.61}\DIFaddend , \textit{p} \textless{}
.001, \textit{95\%CI}{[}\DIFdelbegin \DIFdel{0.05, 0.17}\DIFdelend \DIFaddbegin \DIFadd{0.06, 0.19}\DIFaddend {]}; also see
...
perceived interaction quality (random slopes model; \textit{b} = \DIFdelbegin \DIFdel{0.65}\DIFdelend \DIFaddbegin \DIFadd{0.62}\DIFaddend ,
\textit{t}(1,605) = \DIFdelbegin \DIFdel{11.82}\DIFdelend \DIFaddbegin \DIFadd{9.60}\DIFaddend , \textit{p} \textless{} .001,
\textit{95\%CI}{[}\DIFdelbegin \DIFdel{0.54, 0.76}\DIFdelend \DIFaddbegin \DIFadd{0.49, 0.74}\DIFaddend {]}). Moreover, when we considered the
...
substantially stronger predictor (random slopes model; \textit{b} =
\DIFdelbegin \DIFdel{0.17}\DIFdelend \DIFaddbegin \DIFadd{0.16}\DIFaddend , \textit{t}(1,600) = \DIFdelbegin \DIFdel{6.25}\DIFdelend \DIFaddbegin \DIFadd{6.56}\DIFaddend , \textit{p} \textless{} .001,
\textit{95\%CI}{[}\DIFdelbegin \DIFdel{0.12, 0.23}\DIFdelend \DIFaddbegin \DIFadd{0.11, 0.21}\DIFaddend {]}) and the unique variance explained by
Allport's Conditions was less than half of its original effect size
(\textit{b} = \DIFdelbegin \DIFdel{0.09}\DIFdelend \DIFaddbegin \DIFadd{0.11}\DIFaddend , \textit{t}(1,600) = \DIFdelbegin \DIFdel{2.89}\DIFdelend \DIFaddbegin \DIFadd{3.54}\DIFaddend , \textit{p} \DIFdelbegin \DIFdel{= 0.004}\DIFdelend \DIFaddbegin \DIFadd{\textless{}
.001}\DIFaddend , \textit{95\%CI}{[}\DIFdelbegin \DIFdel{0.03, 0.15}\DIFdelend \DIFaddbegin \DIFadd{0.05, 0.18}\DIFaddend {]}; also see
...
% aims re-iterated
The main aim of this project was to test the basic tenets of the intergroup contact hypothesis and Allport's optimal conditions in real-life extensive longitudinal data \DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{as well as }\DIFaddend to test whether the fulfillment of situational \DIFdelbegin \DIFdel{psychological }\DIFdelend needs meaningfully predicts positive interaction perceptions and outgroup attitudes. 
