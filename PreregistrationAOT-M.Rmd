...
1. \label{hyp:contact}Based on the most general understanding of the contact hypothesis, an increase in frequency and quality of contact should jointly account for changes in more favorable outgroup attitudes.
    ...
    b. \label{hyp:contactDummy}Outgroup attitudes should be higher after an intergroup interaction compared to a time with no outgroup interaction. OR: Outgroup attitudes should increase more after an intergroup interaction compared to a time with no outgroup interaction.
    ...
    d. \label{hyp:contactQualCor}Alternative to H\ref{hyp:contactFreqQual}: Interaction quality should relate positively with outgroup attitudes.
