\begin{tikzpicture}[font=\sffamily]
    ...
    \draw[-latex] (x.north) -- node[auto] {0.39****} (m.west);
    \draw[-latex] (m.east) -- node[auto] {0.45***} (y.north);
    \draw[-latex] (x.east) -- node[below=2mm, align=center] {0.12} (y.west);
...
\begin{tikzpicture}[font=\sffamily]
    ...
    \draw[-latex] (x.north) -- node[auto] {0.20****} (m.west);
    \draw[-latex] (m.east) -- node[auto] {0.22****} (y.north);
    \draw[-latex] (x.east) -- node[below=2mm, align=center] {0.09*} (y.west);
