...
workerMlCor <-
  MlCorMat(
    ...
    labels = c("Core Need", "Competence", "Autonomy", "Relatedness", "Quality", "Accidental", "Voluntary", "Attitudes NL")
  ) 
...
medicalMlCor <-
  MlCorMat(
    ...
    labels = c("Core Need", "Competence", "Autonomy", "Relatedness", "Allport", "Quality", "Accidental", "Voluntary", "Attitudes NL", "Well-being")
  ) 
...
dt_exp_s1 <- workerWithinBetween %>%
  transmute(
    ...
    AttitudeC = thermometerDutch_1_zwc,
    AttitudeZ = thermometerDutch_1_zwc,
    CoreNeedRaw = keyMotiveFulfilled,
