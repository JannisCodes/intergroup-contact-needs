...
workerMlCor <-
  MlCorMat(
    data = workerInteractionType,
    id = "PID",
    selection = c("keyMotiveFulfilled", "competence.daily.all", "autonomy.daily.all", "relatedness.daily.all", "quality_overall_1", "interaction_accidental", "interaction_voluntary", "thermometerDutch_1"),
...
studentMlCor <-
  MlCorMat(
    data = studentInteractionType,
    id = "PID",
    selection = c("KeyNeedFullfillment", "Competence", "Autonomy", "Relatedness", "quality_overall", "interaction_accidental", "interaction_voluntary", "AttitudesDutch"),
    labels = c("Core Need", "Competence", "Autonomy", "Relatedness", "Quality", "Accidental", "Voluntary", "Attitudes NL")
  ) 
...
medicalMlCor <-
  MlCorMat(
    data = dtMedical$full,
    id = "PID",
    selection = c("KeyNeedFulfillment", "Competence", "Autonomy", "Relatedness", "AllportsCondition", "qualityOverall", "interaction_accidental", "interaction_voluntary", "AttitudesDutch", "exWB"),
...
dt_goal_s1 <- workerOutWithinBetween %>%
  transmute(
    ...
    Quality = quality_overall_1,
    QualityC = quality_overall_1_cwc,
    QualityZ = quality_overall_1_zwc,
    WellBeing = ExWB_1,
