...
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{ccccccccccccccccccccccccccc}
\toprule
...
$\tau_{11}$ &  &  & 0.05 (PID.CoreNeed) &  & 0.05 (PID.CoreNeed)
0.04 (PID.Quality) &  & 0.12 (PID.CoreNeed) &  & 0.02 (PID.CoreNeed) &  & 0.00 (PID.CoreNeed)
0.04 (PID.Quality) &  & 0.09 (PID.CoreNeed) &  & 0.05 (PID.CoreNeed) &  & 0.03 (PID.CoreNeed)
0.02 (PID.Quality) &  & 0.11 (PID.Allport) &  & 0.05 (PID.Allport) &  & 0.02 (PID.Allport)
0.02 (PID.Quality) &  & 0.00 (PID.CoreNeed)
\hspace{1em}0.04 (PID.Allport) & \\
$\rho_{01}$ &  &  & 0.03 (objVar$cor.slope_intercept.) &  & 0.37 (PID.CoreNeed)
-0.22 (PID.Quality) &  & -0.09 (objVar$cor.slope_intercept.) &  & -0.16 (objVar$cor.slope_intercept.) &  & -0.18 (PID.CoreNeed)
-0.06 (PID.Quality) &  & -0.26 (objVar$cor.slope_intercept.) &  & -0.26 (objVar$cor.slope_intercept.) &  & -0.14 (PID.CoreNeed)
-0.41 (PID.Quality) &  & -0.07 (objVar$cor.slope_intercept.) &  & -0.19 (objVar$cor.slope_intercept.) &  & 0.12 (PID.Allport)
-0.51 (PID.Quality) &  & -1.00 (PID.CoreNeed)
\hspace{1em}-0.07 (PID.Allport) & \\
