...
t(1200) = 4.36, extit\{p\} = \textless{} .001, extit\{95\%CI{[}1.36,
3.59{]}), even after controlling for having an interaction with a
non-Dutch (which did not relate to outgroup attitudes independently; For
full results see Online Supplementary Materials
...
t(365) = 2.93, extit\{p\} = = 0.004, extit\{95\%CI{[}0.06, 0.30{]}) and
also predicted higher perceived interaction quality (random intercept
model; extit\{b\} = 0.42, t(365) = 8.07, extit\{p\} = \textless{} .001,
extit\{95\%CI{[}0.32, 0.52{]}). However, if we consider the influences
...
interaction quality (random slopes mode; extit\{b\} = 0.23, t(364) =
4.22, extit\{p\} = \textless{} .001, extit\{95\%CI{[}0.12, 0.33{]}) and
only little unique variance is still explained by core need fulfillment
( extit\{b\} = 0.04, t(364) = 0.64, extit\{p\} = = 0.523,
extit\{95\%CI{[}-0.08, 0.15{]}). We thus find support for our hypotheses
and can conclude that in this data set the fulfillment of core
situational needs had a significant influence on outgroup attitudes and
that this effect is likely explained by its effect through perceived
interaction quality.
