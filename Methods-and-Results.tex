...
\textbackslash textit\{95\%CI\}{[}0.06, 0.30{]}) and also predicted
higher perceived interaction quality (random intercept model; \textit{b}
= 0.42, t(365) = 8.07, \textit{p} = \textless{} .001,
\textbackslash textit\{95\%CI\}{[}0.32, 0.52{]}). However, if we
