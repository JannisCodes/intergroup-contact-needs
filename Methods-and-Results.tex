...
\ref{tab:intergroupGeneralTblWide}). We additionally used a multilevel
...
\ref{tab:intergroupGeneralTblWide} and Online Supplementary Materials
...
\ref{tab:intergroupNeedsTblWide}).
...
\ref{tab:robustnessTblWide}). Together with a significant main effect of
...
\ref{tab:robustnessTblWide} and Online Supplementary Information B.
...
see Table \ref{tab:intergroupGeneralTblWide}). We additionally used a
...
0.07{]}; also see Table \ref{tab:intergroupNeedsTblWide} for full
...
full results see Table \ref{tab:intergroupNeedsTblWide} and for visual
...
sample. For full results see Table \ref{tab:intergroupNeedsTblWide} and
...
Table \ref{tab:intergroupGeneralTblWide} and Online Supplementary
...
\ref{tab:intergroupNeedsTblWide} and Figure
...
\ref{tab:robustnessTblWide} and Figure \ref{fig:Robustness} as well as
Online Supplementary Information B.
