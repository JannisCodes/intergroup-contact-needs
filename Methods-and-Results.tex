...
(\(AIC_{CoreNeed}\) 12632.0183 \textless{} 12651.5868 \(AIC_{Allport}\),
and \(BIC_{CoreNeed}\) 12664.549 \textless{} 12684.1174
...
Conditions: \textit{b} = 0.16, \textit{t}(1600) = 4.92, \textit{p}
\textless{} .001, \textit{95\%CI}{[}0.09, 0.24{]}, Core Need: \textit{b}
= 0.14, \textit{t}(1600) = 3.85, \textit{p} \textless{} .001,
...
\textit{95\%CI}{[}3.73, 7.09{]}), this indicates that it is not key need
...
\textit{t}(1598) = 2.73, \textit{p} = 0.006, \textit{95\%CI}{[}0.01,
