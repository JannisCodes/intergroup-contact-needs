...
We again started with a general test of the contact hypothesis, as in
Studies 1 and 2. We found no significant correlation between intergroup
contact and average outgroup attitudes --- for neither the total number
of outgroup interactions nor the number of measurement beeps with an
interaction (\textit{r} \textless{} 0.13, \textit{p} \textgreater{}
0.291). However, we did find a significant correlation between the
participants' Average Interaction Quality and their Average Outgroup
Attitudes (\textit{r} = 0.25, \textit{p} = 0.036). When considering the
...
This result mirrors that of study one but is inconsistent with the
second study. Additionally in a multilevel regression to check for
contemporaneous effects within the participants, we found that having an
outgroup interaction was indeed associated with significantly more
...
Supplementary Materials B). Thus, in our third data set we again found
...
contemporaneous effect of intergroup contact is consistent across all
three studies.
