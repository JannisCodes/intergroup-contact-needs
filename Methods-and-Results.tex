...
intergroup contact, whether the need fulillment effect is a affected by
...
interaction as `accidental'. It should be noted at this point, that in
order to keep the ESM surveys short, we asked our participants to focus
on most the important interaction (i.e.,
...
the moderation analysis. We find that \hl{...}.
...
find that \hl{...}. The analysis, thus, adds weight to the importance of
considering the need fulfillment experiences when it comes to outgroup
interactions.
...
For each of the topics, we had identified in the topic modeling
analysis, we extracted the top 10 most indicative words as well as the
three most representative free text responses. Using a detailed coding
protocol for both the practical as well as the psychological motives,
two independent coders rated each of the 47 topics. This allowed us to
add the two dimensions back to each of the reported interaction motives
and assess the distributions and effects of the goal-directed character.
We found that \hl{...}.
