...
(\fgrref{fig:ContactHypothesis}), the core need fulfillment proposal
(\fgrref{fig:AllportNeedFulfillment}), as well as the robustness
analyses (\fgrref{fig:Robustness}). For the basic contact hypothesis
...
at \fgrref{fig:AllportNeedFulfillment}, we see that the fulfillment of
