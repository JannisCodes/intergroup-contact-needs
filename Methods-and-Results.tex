...
t(365) = 2.93, \textit{p} = = 0.004, \textit{95\%CI}{[}0.06, 0.30{]})
and also predicted higher perceived interaction quality (random
intercept model; \textit{b} = 0.42, t(365) = 8.07, \textit{p} =
...
still explained by core need fulfillment (\textit{b} = 0.04, t(364) =
0.64, \textit{p} = = 0.523, \textit{95\%CI}{[}-0.08, 0.15{]}). We thus
find support for our hypotheses and can conclude that in this data set
the fulfillment of core situational needs had a significant influence on
