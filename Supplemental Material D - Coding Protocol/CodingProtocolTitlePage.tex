...
% Title and header
\title{Supplemental Information D: Coding Protocol Goal Directedness}
\shorttitle{SI B: Coding Protocol}
%\author{Jannis Kreienkamp, Maximilian Agostini, Laura F. Bringmann, Peter de Jonge, Kai Epstude}
\author{[authors masked for peer review]}
\newcommand{\manuscript}{Need Fulfillment During Intergroup Contact: Three Experience Sampling Studies}
