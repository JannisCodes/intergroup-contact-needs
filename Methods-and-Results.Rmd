...
histogram(dtWorkerSupp$workerAvFreQual$SumContactNL)
histogram(dtWorkerSupp$workerAvFreQual$PercContactNL)

histogram(dtWorkerSupp$workerAvFreQual$WinSumContactNL)

dtWorkerSupp$workerAvFreQual$WinSumContactNL %>% max

DescTools::Winsorize(dtWorkerSupp$workerAvFreQual$PercContactNL)

dtWorkerSupp$workerAvFreQual$PercContactNL[dtWorkerSupp$workerAvFreQual$PercContactNL > 0] %>% max %>% round(2) %>% format(nsmall=2)

# misty::multilevel.descript(dtWorkerSupp$workerAvFreQual$SumContactNL, cluster = dtWorkerSupp$workerAvFreQual$ExternalReference)
```
