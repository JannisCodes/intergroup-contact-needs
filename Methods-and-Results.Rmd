...
sjstats::r2(mdlWorkerOut$Att$lmerSlopesCore, mdlWorkerOut$Att$lmerNull)
performance::r2(mdlWorkerOut$Att$lmerSlopesCore)
performance::model_performance(mdlWorkerOut$Att$lmerSlopesCore)
performance::compare_performance(mdlWorkerOut$Att$lmerNull, mdlWorkerOut$Att$lmerSlopesCore)
...
mdlWorkerOut$Att$varSlopesCore <- 
  lme4::VarCorr(mdlWorkerOut$Att$lmerSlopesCore)
