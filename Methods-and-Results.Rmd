...
mdlMedical$lmerInterceptAttTypeCI <- confint(mdlMedical$lmerInterceptAttType)
...
mdlMedical$lmerSlopesAttTypeCI <- confint(mdlMedical$lmerSlopesAttType)
...
mdlMedicalOut$Att$lmerInterceptAllportCI <- 
  confint(mdlMedicalOut$Att$lmerInterceptAllport)
...
# 95%CIs
mdlMedicalOut$Att$lmerSlopesAllportCI <- confint(mdlMedicalOut$Att$lmerSlopesAllport)
...
# generate 95% parametric bootstrap CIs (and save them as a csv-file):
# write.csv(confint(lmer(AttitudesDutch~1 + (1|PID),data=medicalOutgroupInteraction),
#                  method="boot",nsim=1000,
#                  parallel = "multicore", ncpus = 4, seed = 42),
#          "output/tables/ML-Null-CI.csv")
...
mdlMedicalOut$Qlt$lmerInterceptAllportCI <- 
  confint(mdlMedicalOut$Qlt$lmerInterceptAllport)

# Generate 95% parametric bootstrap CIs (and save them as a csv-file):
# write.csv(confint(lmer(qualityOverall ~ Contact_dum + inNonDutch + (1|PID),data=medicalOutgroupInteraction),
#                  method="boot",nsim=1000, parallel = "multicore",
#                  ncpus = 4, seed = 42),
#          "output/tables/ML-Inter-CI.csv")
...
mdlMedicalOut$Qlt$lmerSlopesAllportCI <- 
  confint(mdlMedicalOut$Qlt$lmerSlopesAllport)

# Generate 95% parametric bootstrap CIs (and save them as a csv-file):
# write.csv(confint(mdlMedicalOut$Qlt$lmerSlopesAllport,
#               method="boot",nsim=1000,
#               parallel = "multicore", ncpus = 4, seed = 42),
#          "output/tables/ML-RandomSlopes-CI.csv")
...
mdlMedicalOut$Att$lmerInterceptAllportQltCI <- 
  confint(mdlMedicalOut$Att$lmerInterceptAllportQlt)

# Generate 95% parametric bootstrap CIs (and save them as a csv-file):
# write.csv(confint(lmer(AttitudesDutch ~ Contact_dum + inNonDutch + (1|PID),data=medicalOutgroupInteraction),
#                  method="boot",nsim=1000, parallel = "multicore",
#                  ncpus = 4, seed = 42),
#          "output/tables/ML-Inter-CI.csv")
...
mdlMedicalOut$Att$lmerSlopesAllportQltCI <- 
  confint(mdlMedicalOut$Att$lmerSlopesAllportQlt)
...
mdlMedicalOut$Att$lmerInterceptCoreCI <-
  confint(mdlMedicalOut$Att$lmerInterceptCore)
...
# 95%CIs
mdlMedicalOut$Att$lmerSlopesCoreCI <- confint(mdlMedicalOut$Att$lmerSlopesCore)
...
mdlMedicalOut$Qlt$lmerInterceptCoreCI <- 
  confint(mdlMedicalOut$Qlt$lmerInterceptCore)
...
mdlMedicalOut$Qlt$lmerSlopesCoreCI <- 
  confint(mdlMedicalOut$Qlt$lmerSlopesCore)

# Generate 95% parametric bootstrap CIs (and save them as a csv-file):
# write.csv(confint(mdlMedicalOut$Qlt$lmerSlopesCore,
#               method="boot",nsim=1000,
#               parallel = "multicore", ncpus = 4, seed = 42),
#          "output/tables/ML-RandomSlopes-CI.csv")
...
mdlMedicalOut$Att$lmerInterceptCoreQltCI <- 
  confint(mdlMedicalOut$Att$lmerInterceptCoreQlt)
...
mdlMedicalOut$Att$lmerSlopesCoreQltCI <- 
  confint(mdlMedicalOut$Att$lmerSlopesCoreQlt)
...
mdlMedicalOut$Att$lmerInterceptCoreAllportCI <- 
  confint(mdlMedicalOut$Att$lmerInterceptCoreAllport)
...
mdlMedicalOut$Att$lmerSlopesCoreAllportCI <- 
  confint(mdlMedicalOut$Att$lmerSlopesCoreAllport, method = "Wald")
...
mdlMedical$lmerInterceptAttCoreIntCI <- 
  confint(mdlMedical$lmerInterceptAttCoreInt)

# Generate 95% parametric bootstrap CIs (and save them as a csv-file):
# write.csv(confint(lmer(AttitudesDutch ~ Contact_dum + inNonDutch + (1|PID),data=dtMedical$full),
#                  method="boot",nsim=1000, parallel = "multicore",
#                  ncpus = 4, seed = 42),
#          "output/tables/ML-Inter-CI.csv")
...
mdlMedical$lmerSlopesAttCoreIntCI <- 
  confint(mdlMedical$lmerSlopesAttCoreInt)
...
mdlMedicalOut$Att$lmerSlopesCoreSdtCI <- 
  confint(mdlMedicalOut$Att$lmerSlopesCoreSdt)
