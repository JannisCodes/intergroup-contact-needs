...
studentMlCor <-
  MlCorMat(
    ...
    labels = c("Core Need", "Competence", "Quality", "Attitudes NL")
  ) 
...
\paragraph{Perceived Interaction Quality}The ratings of the perceived contact quality were identical to Study 1.
...
\paragraph{Psychological Needs}The measurement of the core situational need and its fulfillment was identical to Study 2.
