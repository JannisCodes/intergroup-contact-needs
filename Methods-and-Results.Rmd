...
for(i in 1:length(var)){
    ...
    meta.parametric.plt.widedata <- data.table::melt.data.table(
      data = meta.parametric.plt.data,
      id.vars = c("effect", "name"),
      ...
      variable = "sample" # sample info missing
    )
